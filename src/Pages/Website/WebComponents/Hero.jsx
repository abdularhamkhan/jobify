...
import FeaturesOnboard from '../../../Assets/FeaturesOnboard.svg'
import rollupsleeves from '../../../Assets/rollupsleeves.svg'
import jobdone from '../../../Assets/jobdone.svg'
            ...
            <main className='mt-10 '>
                <div className='flex justify-evenly xsm:max-lg:flex-col xsm:max-lg:items-center xsm:max-lg:gap-4'>
                    <div className='w-1/2 shadow-2xl p-6 rounded-2xl dark:shadow-primary xsm:max-lg:w-full'>
                        ...
                        <h4 className='mt-4 text-justify font-bold text-4xl xsm:max-md:text-2xl'>Find work and hire talents all on one platform. You can have the best people, right here, right now — no need to follow the old rules. </h4>
                ...
                <div className='mt-4 flex justify-evenly xsm:max-lg:flex-col xsm:max-lg:items-center xsm:max-lg:gap-4'>
                ...
                <div className='mt-12 flex justify-evenly xsm:max-lg:flex-col xsm:max-lg:items-center xsm:max-lg:gap-4'>
                    <div className='w-1/2 shadow-2xl p-6 rounded-2xl dark:shadow-primary xsm:max-lg:w-full'>
